...
import com.juaracoding.cucumber.drivers.pages.RecruitmentPage;
...
//		Hooks.delay(1);
    ...
    public void user_enter_fullname() {
        recruitmentPage.fullname("Andri", "", "Yansyah");
    ...
    public void user_enter_notes() {
        recruitmentPage.notes("Hanya Tes aja");
    ...
    public void user_select_search_candidate_by_date() {
        recruitmentPage.menuRecruitment();
        recruitmentPage.searchCandidateByDate("2022-11-01");
    ...
    public void user_showing_linda_anderson_by_hiring_manager() {
        Assert.assertEquals(recruitmentPage.getTxtCandidateName(), ("Andri Yansyah"));
